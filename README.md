# Cloud Formation buildpack for Rust

> This is a fork of https://github.com/emk/heroku-buildpack-rust, tweaked to work on cloudformation (or at least, our cloudformation deployment). 
